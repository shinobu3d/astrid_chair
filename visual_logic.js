 ...
 * Mon Sep 26 2022 13:50:12 GMT+0530 (India Standard Time)
...
eventHTMLElem('click', 'M1_button', true, function(event) {
  assignMat('chair', 'M1');
});
eventHTMLElem('click', 'M2_button', true, function(event) {
  assignMat('chair', 'M2');
});
eventHTMLElem('click', 'M3_button', true, function(event) {
  assignMat('chair', 'M3');
});
eventHTMLElem('click', 'M4_button', true, function(event) {
  assignMat('chair', 'M4');
});
